...
Guides for the Olla marketing website.

| Document | Contents |
| --- | --- |
| [Getting Started](getting-started.md) | Install, run, build, env vars |
| [Architecture](architecture.md) | Folders, routing, UI stack, data |
